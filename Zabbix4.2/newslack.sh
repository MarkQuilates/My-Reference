...
url='https://hooks.slack.com/services/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'      # example: url='https://hooks.slack.com/services/QW3R7Y/D34DC0D3/BCADFGabcDEF123'
...
recoversub='^RECOVER(Y|ED)?$|^OK$|^RESOLVED.*|^Resolved.*'
