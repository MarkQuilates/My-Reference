...
zabbix_host = 'zabbix-aws.teraops101.com'   # Zabbix server IP
zabbix_port = 10051         # Zabbix server port
hostname = 'vpshighproxy2'   # Name of monitored host, like it shows in zabbix web ui
time_delta = 1              # grep interval in minutes

# URL to nginx stat (http_stub_status_module)
stat_url = 'http://127.0.0.1/dE8hoCJoyutI0roNOnsaE3UmsKdA9Cet'
...
for status in 200,301,302,304,400,401,403,404,429,499,500,502,503,504:
