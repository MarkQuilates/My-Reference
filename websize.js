...
var confess = {
    ...
    performance: {
        ...
        onLoadFinished: function (page, config, status) {
            ...
            console.log('');
            console.log('Elapsed load time: ' + this.pad(elapsed, 1) + 'ms');
            console.log('   # of resources: ' + this.pad(resources.length-1, 1));
            console.log('');
            console.log(' Fastest resource: ' + this.pad(fastest.duration, 1) + 'ms; ' + this.truncate(fastest.url));
            console.log(' Slowest resource: ' + this.pad(slowest.duration, 1) + 'ms; ' + this.truncate(slowest.url));
            console.log('  Total resources: ' + this.pad(totalDuration, 1) + 'ms');
            console.log('');
            console.log('Smallest resource: ' + this.pad(smallest.size, 1) + 'b; ' + this.truncate(smallest.url));
            console.log(' Largest resource: ' + this.pad(largest.size, 1) + 'b; ' + this.truncate(largest.url));
            console.log('  Total resources: ' + this.pad(totalSize, 1) + 'b' + (missingSize ? '; (at least)' : ''));
            if (config.verbose) {
                console.log('');
                var ths = this,
                    length = 1024,
                ...
                resources.forEach(function (resource) {
                    console.log(
                        ...
                        ths.pad(resource.duration, 1) + 'ms; ' +
                        ths.pad(resource.size, 1) + 'b; ' +
                        ths.truncate(resource.url, 100)
                    );
                });
            }
        }
